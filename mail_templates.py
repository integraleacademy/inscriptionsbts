...
<p style="margin-top:30px;">
    ...
    """
        ...
        "candidature_validee": {
    "title": "Candidature validée – Confirmez votre inscription",
    "content": f"""
        <p>Bonjour {prenom},</p>

        <!-- 🔥 INTRO AVIS FAVORABLE -->
        <p>
        Nous revenons vers vous suite à votre candidature concernant notre
        <strong>{bts_label}</strong> en alternance,
        {"<strong>en présentiel (Puget sur Argens, Var)</strong>" if "présentiel" in form_mode_label.lower() or "puget" in form_mode_label.lower() else "<strong>en 100% en ligne à distance en visioconférence ZOOM</strong>"}.
        </p>

        <p>
        Après avoir étudié votre dossier, notre commission d'admission a décidé de donner un
        <strong style="color:#0a8a00;font-size:17px;">AVIS FAVORABLE 🥳</strong>
        à votre demande d’admission au sein de notre école Intégrale ACADEMY.
        </p>

        <!-- 🔥 BLOC CONFIRMATION -->
        <div style="background:#fff6d9;border:1px solid #f4c45a;padding:18px;border-radius:10px;margin:25px 0;text-align:center;">
            <p style="font-size:16px;font-weight:600;margin:0 0 12px 0;">
                Maintenant que votre candidature est validée 🎉<br>
                <span style="color:#000;">si vous souhaitez intégrer notre école,</span><br>
                nous vous remercions de bien vouloir confirmer votre inscription en cliquant sur le bouton ci-dessous :
            </p>

            <a href="{lien_espace}"
               style="display:inline-block;background:#f4c45a;color:#000;padding:12px 20px;
