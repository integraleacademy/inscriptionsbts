    ...
    """
        ...
        "parcoursup_import": {
            ...
            "content": f"""
                ...
                <p>
                  🎓 Nous avons bien reçu votre candidature Parcoursup pour le <strong>{bts_label}</strong>.<br>
                ...
                <div style="margin:20px 0;padding:16px 18px;border-radius:10px;background:#f6fbff;border:1px solid #dbeafe;">
                  ...
                  <p style="margin:0;font-size:14px;line-height:1.6;">
                    Pour que votre dossier soit étudié par notre équipe admissions, vous devez maintenant
                    <strong>compléter votre pré-inscription</strong> via votre espace candidat.
                  </p>
                </div>
                ...
                <div style="margin:20px 0;padding:16px 18px;border-radius:10px;background:#f9fafb;border:1px solid #e5e7eb;">
                  <p style="margin:0 0 10px 0;font-size:15px;"><strong>✅ Ce qui se passe ensuite :</strong></p>
                  <ol style="margin:8px 0 0 18px;padding:0;line-height:1.7;font-size:14px;">
                    <li>Vous finalisez la pré-inscription.</li>
                    <li>Notre commission étudie votre dossier.</li>
                    <li>Vous recevez une réponse par email et SMS.</li>
                    <li>En cas d’avis favorable, vous confirmez votre inscription.</li>
                  </ol>
                </div>
